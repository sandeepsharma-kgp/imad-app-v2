...
var articles= {
    'article-one':{
        title: 'Article One|Sandeep Sharma',
        heading: 'Article One',
        date: 'Feb 3 , 2017',
        content:`
            <p>
    ...
    'article-two':{
        title: 'Article Two|Sandeep Sharma',
        heading: 'Article Two',
        date: 'Feb 4 , 2017',
        content:`
            <p>
    ...
    'article-three':{title: 'Article Three|Sandeep Sharma',
...
var names=[];
app.get('/submit-name', function (req, res) { //URL :/submit-nmae?name-xxxx
...
app.get('/articles/:articleName',function(req,res){
    ...
    pool.query("SEECT * FROM article WHERE title= '"+req.params.articleName+"'",function(err,result){
        if(err){
            res.status(500).send(err.toString());
        }
        else{
